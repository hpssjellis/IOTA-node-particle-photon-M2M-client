...
const myParticleId = '888888888888888888888888'    // not needed on client
const myParticleAccessToken = 'abc88d8888888ef8888ghi8888j88k88l888mnop'   // not needed on client



global.mySpecialReceiveAddress = 'ALOQIWEUOMGFLAAUIAINIRONFGNGB9HOBFFJJCLRPMHLHWOZEBMDPJZYUXQXHTEUNYFWENEIJXIYDKKOWVIEKBSNSZ' // Only on client this needs to be set before running program
global.myValueToSend = 200   // IOTA to send each 5 min
...
global.myReceiveAddress = '' // Autogenerated
global.myReceiveAddressOld = '' // Autogenerated
...
iota
  ...
  //   global.myResponse0 = '<h2>My Next '+myMaxArray+' Addresses: </h2>' + '<pre id="myPre01">'+JSON.stringify(myGenAddress, null, 3)+'</pre>' + '<hr>';  // hopefully this is global
     ...
     global.myReceiveAddressOld = global.myReceiveAddress
...
iota
  ...
  .then(myGenAddress => {
    ...
    global.myReceiveAddressOld = global.myReceiveAddress
      ...
      global.myArrayOfAddresses.push(global.myReceiveAddress)
  })
  .catch(err => {
    console.log(err)
  })
...
function myFirstSend(myPassedSeed){

	var options = {
        checksum: true,
		security: 2,
        index: global.myArrayOfAddresses.length-1,     // no -1 for next address
        total:3
	}
...
iota
  ...
  .then(myGenAddress => {
      ...
      console.log('myGenAddress first')
      console.log(myGenAddress)
      console.log('myGenAddress[1]')
      console.log(myGenAddress[1])

      mySendMessage(global.mySpecialReceiveAddress, myGenAddress[1])


     // global.myReceiveAddress = myGenAddress   // need a refresh from browser side to see this?
     // console.log('Generating new receive address')
      console.log('global.mySpecialReceiveAddress')
      console.log(global.mySpecialReceiveAddress)
      console.log('myGenAddress')
      console.log(myGenAddress)
...
iota
  ...
  .then(myGenAddress => {
     // global.myReceiveAddress = myGenAddress[0]   // need a refresh from browser side to see this?
     console.log('myGenAddress general')
      console.log(myGenAddress)
      console.log('myGenAddress[1]')
      console.log(myGenAddress[1])
     ...
     // console.log('global.myReceiveAddress')
      ...
      //  let myMessageToSendMain = global.myReceiveAddress
           ...
           mySendMessage(mySendToAddressMain, myGenAddress[1])
...
///myFirstSend(mySeed)   // inside myLoadAddressesFromSeed
...
*/
     ...
     let myInt =  setInterval( function() {
       ...
       console.log(' ')
      console.log('global.myArrayOfAddresses[global.myArrayOfAddresses.length-3]')
      console.log(global.myArrayOfAddresses[global.myArrayOfAddresses.length-3])

      console.log('global.myArrayOfAddresses[global.myArrayOfAddresses.length-2]')
      console.log(global.myArrayOfAddresses[global.myArrayOfAddresses.length-2])

      console.log('global.myArrayOfAddresses[global.myArrayOfAddresses.length-1]')
      console.log(global.myArrayOfAddresses[global.myArrayOfAddresses.length-1])
       ...
       myIncoming = global.myReceiveAddress
       if (myIncoming.length == 90){
          // console.log(myIncoming)
           myIncoming = myIncoming.substring(0, 81)
          // console.log(myIncoming)
       ...
       myIncoming = global.myReceiveAddressOld
       if (myIncoming.length == 90){
          // console.log(myIncoming)
           myIncoming = myIncoming.substring(0, 81)
          // console.log(myIncoming)
...
let myIncoming = global.myArrayOfAddresses[global.myArrayOfAddresses.length-2]
